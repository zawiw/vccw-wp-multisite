...
packages = %w{git subversion zip unzip kernel-devel gcc perl make jq libxml2-devel libcurl-devel libjpeg-turbo-devel libpng-devel giflib-devel gd-devel libmcrypt-devel sqlite-devel libtidy-devel libxslt-devel}
